...
@section('content')
<div class="card p-2">
  <h3 class="text-center mb-4 mt-3">Data Pasien Hari Ini</h3>
  {{-- message --}}
  ...
  <div class="row">
    <div class="col">
      <ol class="breadcrumb">
        <li class="breadcrumb-item" id="all-data"><a href="/Pasien">Semua data</a></li>
        <li class="breadcrumb-item" id="day-data"><a href="/pasien-data" style="text-decoration: underline;">Data hari ini</a></li>
      </ol>
    </div>
  </div>
