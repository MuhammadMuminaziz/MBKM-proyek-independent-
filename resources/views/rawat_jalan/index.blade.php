...
<div class="row justify-content-between px-2 mb-3">
    ...
    <a href="" data-toggle="modal" data-target="#uploadPoliUmumModal"><button class="btn btn-sm btn-primary"><i class="fa fa-upload" aria-hidden="true"></i> Upload Data</button></a>
</div>
...
<!-- Modal Upload Data -->
<div class="modal fade" id="uploadPoliUmumModal" tabindex="-1" aria-labelledby="uploadPoliUmumModalLabel" aria-hidden="true">
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="uploadPoliUmumModalLabel">Upload Data {{ $title }}</h5>
